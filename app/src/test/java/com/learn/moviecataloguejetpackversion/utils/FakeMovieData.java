...
public class FakeMovieData {
    ...
    public static ArrayList<Movie> generateMovieList() {
        ...
        movie.add(new Movie("0000", "/udDclJoHjfjb8Ekgsd4FDteOkCU.jpg", "Joker", "During the 1980s, a failed stand-up comedian is driven insane and turns to a life of crime and chaos in Gotham City while becoming an infamous psychopathic crime figure.", "8.5", "2019-10-04", "534.771", "/n6bUvigpRFqSwmPp1m2YADdbRBc.jpg"));
        ...
        movie.add(new Movie("0004", "/ePXuKdXZuJx8hHMNr2yM4jY2L7Z.jpg", "El Camino: A Breaking Bad Movie", "In the wake of his dramatic escape from captivity, Jesse Pinkman must come to terms with his past in order to forge some kind of future.", "7.1", "2019-10-11", "108.112", "/ijiE9WoGSwSzM16zTxvUneJ8RXc.jpg"));

        movie.add(new Movie("0005", "/g4z7mDmJmx23vsVg6XNWcnXb6gc.jpg", "47 Meters Down: Uncaged", "A group of backpackers diving in a ruined underwater city discover that they have stumbled into the territory of the ocean's deadliest shark species.", "5.1", "2019-08-16", "107.197", "/3uG3aOhEzFCjcQulsJQiAzLSrw8.jpg"));

        movie.add(new Movie("0006", "/pIcV8XXIIvJCbtPoxF9qHMKdRr2.jpg", "Zombieland: Double Tap", "Columbus, Tallahassee, Wichita, and Little Rock move to the American heartland as they face off against evolved zombies, fellow survivors, and the growing pains of the snarky makeshift family.", "7.4", "2019-10-18", "106.325", "/jCCdt0e8Xe9ttvevD4S3TSMNdH.jpg"));

        movie.add(new Movie("0007", "/tximyCXMEnWIIyOy9STkOduUprG.jpg", "Good Boys", "A group of young boys on the cusp of becoming teenagers embark on an epic quest to fix their broken drone before their parents get home.", "6.6", "2019-08-16", "122.885", "/zIZv4pPJRg3YTnWWuotwXnYu1fM.jpg"));

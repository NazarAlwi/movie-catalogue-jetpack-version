...
public class FakeTvShowData {
    ...
    public static ArrayList<TvShow> generateTvShowList() {
        ...
        tvShows.add(new TvShow("0008", "/jnsvc7gCKocXnrTXF6p03cICTWb.jpg", "Grey's Anatomy", "Follows the personal and professional lives of a group of doctors at Seattle’s Grey Sloan Memorial Hospital.", "6.4", "2005-03-27", "128.762", "/edmk8xjGBsYVIf4QtLY9WMaMcXZ.jpg"));

        tvShows.add(new TvShow("0009", "/v9zc0cZpy5aPSfAy6Tgb6I1zWgV.jpg","South Park", "Follows the misadventures of four irreverent grade-schoolers in the quiet, dysfunctional town of South Park, Colorado.", "7.8","1997-08-13", "117.581", "/mSDKNVvDfitFE6Fb6fSSl5DQmgS.jpg"));
